...
const customerSchema = new mongoose.Schema(
  {
    ...
    // Set via POST /api/customers/aadhaar-scan at Aadhaar-scan time (before
    // this customer record itself is created), then carried through as a
    // normal field value on the create-customer payload - same
    // upload-first-attach-later pattern as recordApi.uploadFile.
    aadhaarPhoto: {
      url: { type: String },
