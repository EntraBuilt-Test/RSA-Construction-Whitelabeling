...
/**
 * Pixel-faithful reproduction of the physical Name delivery note pad:
...
export default function DeliveryNotePrint() {
  ...
  const handleShareWhatsApp = async () => {
    ...
    try {
      ...
      const message =
        `Name - Delivery Note ${note.noteNumber}\n` +
  ...
  return (
    <div className="print-page-wrapper">
      ...
      <div className="delivery-note-sheet" ref={frontSheetRef}>
        <div className="dn-header">
          <div className="dn-header-top">
            ...
            <div className="dn-cell-block">
              <div>{t('print.cellLabel')} : xxxx</div>
              <div>yyyy</div>
            </div>
          </div>
        ...
        </div>        <div className="dn-footer-banner">BillVortex</div>
